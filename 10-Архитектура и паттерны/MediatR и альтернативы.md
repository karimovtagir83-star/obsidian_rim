...
Mediator — поведенческий паттерн из каталога GoF (см. [[Паттерны GoF: поведенческие]]). В оригинале он про то, что множество объектов не общаются друг с другом напрямую, а через посредника, чтобы не превратиться в граф «все со всеми».
