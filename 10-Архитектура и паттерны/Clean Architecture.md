...
Правило зависимостей физически невозможно соблюсти без инверсии: сценарию нужно сохранить заказ, а хранилище — снаружи. Разрешает это конфликт то, что подробно разобрано в [[SOLID]] и в DIP из [[SOLID]]: **интерфейс объявляется там, где он потребляется, а не там, где реализуется**.
