...
Подробнее про кортежи — [[Кортежи и деконструкция]].
...
> ```
> Почему так: компилятор поднимает захваченную переменную в поле класса-замыкания; у `for` этот класс один на весь цикл. Детали — [[Локальные функции и замыкания]].
>
